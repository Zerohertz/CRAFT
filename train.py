...
class Trainer(object):
    ...
    def get_synth_loader(self):
        ...
        dataset = SynthTextDataSet(
            ...
            data_dir=self.config.train.synth_dir,
            saved_gt_dir=None,
    ...
    def train(self, buffer_dict):
        ...
        while train_step < whole_training_step:
            ...
            print('='*10, 'Train Step: ', train_step, '/', whole_training_step, '='*10)
            print('GPU: ', self.gpu)
            for (
                index,
                (
                ...
                print('='*10, 'Index: ', index, '/', len(trn_real_loader), '='*10)
                craft.train()
