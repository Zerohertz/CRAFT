...
lib = ctypes.CDLL('utils/cpp_bindings/build/libfast_boxes.so')
...
c_find_word_boxes.argtypes = [
    ndpointer(ctypes.c_float, flags='C_CONTIGUOUS'), # const float *textmap
    ctypes.c_int, # int textmapWidth
    ctypes.c_int, # int textmapHeight
    ndpointer(ctypes.c_int, flags='C_CONTIGUOUS'), # const int* labels
    ctypes.c_int, # int nLabels
    ndpointer(ctypes.c_float, flags='C_CONTIGUOUS'), # float *statsLeft
    ndpointer(ctypes.c_float, flags='C_CONTIGUOUS'), # float *statsTop
    ndpointer(ctypes.c_float, flags='C_CONTIGUOUS'), # float *statsWidth
    ndpointer(ctypes.c_float, flags='C_CONTIGUOUS'), # float *statsHeight
    ndpointer(ctypes.c_float, flags='C_CONTIGUOUS'), # float *statsArea
    ctypes.c_float, # float textThreshold
    ctypes.c_int, # int fastMode
    ctypes.c_int, # int rotatedBox
    ndpointer(ctypes.c_float, flags='C_CONTIGUOUS'), # float *outBoxes
    ndpointer(ctypes.c_int, flags='C_CONTIGUOUS'), # int *outLabels
]
