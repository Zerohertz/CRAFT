...
try:
    sys.path.insert(0, "/utils/cpp_bindings/cpp_bindings.py")
    from utils.cpp_bindings.cpp_bindings import find_char_boxes, find_word_boxes
...
def getDetBoxes_core(textmap, linkmap, text_threshold, link_threshold, low_text,
                     use_cpp_bindings=True, fast_mode=False, rotated_box=True):
    # prepare data
